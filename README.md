...
curl -fsSL -o pbschema-lens.tgz \
  https://github.com/ymmt2005/pbschema-lens/releases/download/v0.2.1/pbschema-lens-0.2.1.tgz
...
A stable name `pbschema-lens.tgz` is also uploaded for `releases/latest/download/pbschema-lens.tgz`. Pin a versioned URL when you care about reproducibility. This repository uses GitHub [immutable releases](https://docs.github.com/en/code-security/concepts/supply-chain-security/immutable-releases): once a Release is published, its Git tag and attached assets cannot be changed or replaced.
